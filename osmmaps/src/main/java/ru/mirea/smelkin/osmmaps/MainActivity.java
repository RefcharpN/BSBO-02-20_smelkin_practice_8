package ru.mirea.smelkin.osmmaps;
...
import ru.mirea.smelkin.osmmaps.databinding.ActivityMainBinding;
...
//        //местоположение
        ...
        mirea.setTitle("smelkin");

        Marker school = new Marker(mapView);
        school.setPosition(new GeoPoint(55.742324, 37.410690));
        school.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"бывшая школа", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
